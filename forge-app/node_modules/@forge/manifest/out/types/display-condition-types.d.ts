...
declare enum ConfluenceContentPermission {
    View = "VIEW",
    Edit = "EDIT",
...
export declare type DisplayConditions = {
    ...
    modules: {
        ...
        'confluence:globalSettings'?: Confluence;
        'confluence:spaceSettings'?: Confluence;
        'confluence:backgroundScript'?: Confluence;
        'confluence:pageBanner'?: Confluence;
        'jiraServiceManagement:portalFooter'?: IssueView;
        'jiraServiceManagement:portalHeader'?: IssueView;
        ...
        'jiraServiceManagement:portalRequestCreatePropertyPanel'?: IssueView;
    };
};
export {};
